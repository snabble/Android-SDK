...
import io.snabble.sdk.screens.onboarding.data.OnboardingItem
...
open class OnboardingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val model: OnboardingModel = getOnboardingModel()
    ...
    private fun getOnboardingModel() =
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            arguments
                ?.getParcelable(requireContext().getString(R.string.bundle_key_model), OnboardingModel::class.java)
        } else {
