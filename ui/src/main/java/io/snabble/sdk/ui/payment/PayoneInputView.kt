    ...
    private fun loadForm() {
        try {
            ...
            val htmlForm = IOUtils
                ...
                .replace("{{hash}}", tokenizationData.hash.orEmpty())
                .replace("{{merchantID}}", tokenizationData.merchantID.orEmpty())
                .replace("{{portalID}}", tokenizationData.portalID.orEmpty())
                .replace("{{accountID}}", tokenizationData.accountID.orEmpty())
