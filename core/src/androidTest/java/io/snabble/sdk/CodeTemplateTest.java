...
public class CodeTemplateTest {
    ...
    public void testTemplateParser() {
        ...
        // valid templates
        Assert.assertNotNull(CodeTemplate.parse("", "96{code:ean13}{embed:6}{price:5}{_}"));
        Assert.assertNotNull(CodeTemplate.parse("", "2{code:5}{i}{embed:5}{_}"));
        ...
        Assert.assertNotNull(CodeTemplate.parse("", "{*}"));

        // invalid templates
        Assert.assertNull(CodeTemplate.parse("", "96{prize:5}"));
        Assert.assertNull(CodeTemplate.parse("", "{prize:5}"));
        Assert.assertNull(CodeTemplate.parse("", "96{code{ean13}{embed:6}{price:5}{_}"));
        Assert.assertNull(CodeTemplate.parse("", "96{price:5"));
        Assert.assertNull(CodeTemplate.parse("", "96{price:5}}"));
        Assert.assertNull(CodeTemplate.parse("", "96{}"));
        Assert.assertNull(CodeTemplate.parse("", "96{}{}"));
        Assert.assertNull(CodeTemplate.parse("", "2{code:5}i}{embed:5}{_}"));
        Assert.assertNull(CodeTemplate.parse("", "01{code:ean14}{code:4}"));
        Assert.assertNull(CodeTemplate.parse("", "{code:abc}"));
        Assert.assertNull(CodeTemplate.parse("", "96{i}{price:5}"));
        Assert.assertNull(CodeTemplate.parse("", "96{i}{embed:6}"));
        Assert.assertNull(CodeTemplate.parse("", "96price:5}"));
        Assert.assertNull(CodeTemplate.parse("", ""));
        Assert.assertNull(CodeTemplate.parse("", "{embed:-1}"));
        Assert.assertNull(CodeTemplate.parse("", "{code:-1}"));
        Assert.assertNull(CodeTemplate.parse("", "{embed:0}"));
        Assert.assertNull(CodeTemplate.parse("", "{code:0}"));
    }

    @Test
    public void testTemplateMatcher() {
        Assert.assertNotNull(CodeTemplate.parse("", "96{code:ean13}{embed:6}{price:5}{_}").match("960000000000000111111222223"));
        ...
        Assert.assertNull(CodeTemplate.parse("", "96{code:ean13}{embed:6}{price:5}{_}").match("970000000000000111111222223"));
        Assert.assertNull(CodeTemplate.parse("", "96{code:ean13}{embed:6}{price:5}{_}").match("96000000000000011111122222"));
    }

    @Test
    public void testWildcardMatcher() {
        Assert.assertNotNull(CodeTemplate.parse("", "{*}").match("0000000000000"));
        Assert.assertNotNull(CodeTemplate.parse("", "{*}").match("0000000000017"));
        Assert.assertNotNull(CodeTemplate.parse("", "{*}").match("2957783000742"));
        Assert.assertNotNull(CodeTemplate.parse("", "{*}").match("4029764001807"));
        Assert.assertNotNull(CodeTemplate.parse("", "{*}").match("ASDF"));
        Assert.assertNotNull(CodeTemplate.parse("", "{*}").match("SKDFHSIDUFS"));
        Assert.assertNotNull(CodeTemplate.parse("", "{*}").match("!73487#48tnq72**"));
        Assert.assertNotNull(CodeTemplate.parse("", "{*}").match("******3732ha"));
    }
    
    @Test
    public void testTemplateInternalChecksum() {
        Assert.assertNotNull(CodeTemplate.parse("", "295778{i}{embed:5}{_}").match("2957783000742"));
        Assert.assertNull(CodeTemplate.parse("", "295778{i}{embed:5}{_}").match("2957784000742"));

        Assert.assertNotNull(CodeTemplate.parse("", "2{code:5}{i}{embed:5}{_}").match("2957783000742"));
        Assert.assertNull(CodeTemplate.parse("", "2{code:5}{i}{embed:5}{_}").match("2957784000742"));
    }
}